  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-16 md:py-24">
      ...
      <div className="mt-14 grid gap-8 md:grid-cols-2">
        <div className="rounded-2xl border border-[var(--line)] bg-[var(--surface)] p-8">
          ...
          <ul className="mt-4 space-y-4 text-[15px] text-[var(--ink-soft)]">
            ...
            <li>
              ...
              <a href="tel:+919999999999" className="hover:text-[var(--ink)]">+91 99999 99999</a>
            </li>
            <li>
              <p className="font-medium text-[var(--ink)]">Email</p>
              <a href="mailto:hello@meridianphysio.example" className="hover:text-[var(--ink)]">
        ...
        <div className="rounded-2xl border border-[var(--line)] bg-[var(--ink)] p-8 text-white">
