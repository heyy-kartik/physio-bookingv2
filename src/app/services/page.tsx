    ...
    <div className="mx-auto max-w-6xl px-6 py-24 md:py-28">
      <FadeUp>
        <div>
          ...
          <h1 className="font-display text-3xl text-[var(--ink)] sm:text-4xl md:text-5xl">Services</h1>
      ...
      <div className="mt-12 divide-y divide-[var(--line)] border-t border-[var(--line)] md:mt-14">
        {services.map((s, i) => (
          <FadeUp key={s.name} delay={i * 0.08}>
            <div className="grid gap-6 py-8 md:grid-cols-[1fr_1fr] md:py-10">
              <div>
      ...
      <FadeUp delay={0.1}>
        <div className="mt-14 rounded-2xl border border-[var(--line)] bg-[var(--surface)] p-6 sm:p-8 md:mt-16 md:p-10">
