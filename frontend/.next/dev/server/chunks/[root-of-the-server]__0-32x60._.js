...
"[project]/src/app/internal-api/newsletter/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["insertSubscriber"])(email);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true
        });
    } catch (err) {
...
const dbPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(dataDir, "appointments.db");
...
function insertSubscriber(email) {
    db.prepare(`INSERT OR IGNORE INTO subscribers (id, email, createdAt) VALUES (?, ?, ?)`).run(crypto.randomUUID(), email.trim().toLowerCase(), new Date().toISOString());
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0-32x60._.js.map